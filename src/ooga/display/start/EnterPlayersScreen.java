...
/**
 * This class makes a player customizer screen that allows players to customize
 * their appearance in game
 *
 * @author Aaric Han
 * @author Henry Huynh
 */
public class EnterPlayersScreen extends Display {
    ...
    private Node makeColorSelection() {
        ...
        for (int i = 1; i < 5; i++) {
            ...
            colorSelectorBox.setId(String.format("%s%d", SELECT_COLOR, i));
